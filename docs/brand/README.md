...
Иконка самого приложения (`public/icon-512.png`) пока другая — столбики
статистики с тех времён, когда карты ещё не было. Если захочется одного лица
везде, её стоит перерисовать под выбранный вариант.
