...
export const THEMES: ZoneTheme[] = [
  ...
  },
  {
    ...
    title: 'Ферма',
    exteriorStages: [
      'первая грядка с пугалом',
      'сарай и курятник',
      'амбар с силосом',
      'мельница над золотыми полями',
    ],
    interior: 'теплица: герой поливает грядки, ящики с урожаем наполняются, лампы досветки горят',
  },
];

/**
 * Сколько станций помещается на карту. Карта статичная (созвон №6), места на
 * ней ровно шесть — поэтому и категорий не больше шести: седьмую создать
 * нельзя. Тем в THEMES столько же, так что каждой категории хватает своей.
 */
