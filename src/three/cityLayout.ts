...
export const CITY_SLOTS: [number, number][] = [
  ...
  spot(-2.4, 4.9), // ближний план слева
  spot(2.5, 5.6), // ближний план справа
  spot(-2.6, -5.2), // дальний план слева
  spot(2.7, -4.3), // дальний план справа
];

/** Габариты города в осях экрана — по ним считается неподвижный кадр камеры. */
export const CITY_HALF_U = 3.4;
export const CITY_HALF_F = 5.6;

/** Радиус мощёной площади вокруг ратуши. */
export const PLAZA_R = 2.35;
